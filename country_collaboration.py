...
def plot_country_collaboration(countries, co_occurrences):
    """Grafica la colaboración entre países"""
    ...
    pos = nx.spring_layout(G)#guarda las coordenas de los nodos
    
    
    countries_list = list(G) #lista de nodos
    
    node_size = countries[countries_list].values # vector con el tamaño de los nodos, segun la cantidad de veces que aparece el pais
